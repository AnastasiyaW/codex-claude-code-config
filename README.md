...
| [dependency-provenance-guard](hooks/dependency-provenance-guard.py) | `PreToolUse` | Blocks direct wheels/archives/Git sources and extra indexes; requires lock/hash-aware installs and checks exact registry versions plus artifact digests |

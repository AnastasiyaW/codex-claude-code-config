# 🔴 РАБОЧАЯ ДИСЦИПЛИНА — ДОВОДИМ ВСЁ ДО КОНЦА (единый канон, 5 столпов)

> **Это единственный источник правды по тому, КАК мы работаем.** Принцип НЕ размазан по файлам:
> все пять столпов собраны здесь, а детальные/механические правила подключены ссылками вниз
...
## Пять столпов (всё в одном месте)
